  ...
  <div id="mhtml">
    <div id = "mbody">
     <div id="wrap">
      ...
      <div className="mid">
        <input type="button" className="email-check" onClick={() => alert('중복@ㅁ@')} value="쳌" />
        <div className="inputarea">
          ...
          <input className="repw-input" type="password" placeholder="Enter your password again" />
        </div>
      </div>
      <div className="bottom">
        <div className="click_area">
          <input type="button" className="btn_reg" onClick={() => alert('가입완@ㅁ@')} value="가입하긔" />
